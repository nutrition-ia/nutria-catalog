...
class NutritionService:
    """Service for nutrition calculation operations"""
    ...
    def calculate_nutrition(
        self,
        food_quantities: List[FoodQuantity]
        ...
        # Create a mapping of food_id to (food, nutrients)
        ...
        for fq in food_quantities:
            ...
            # Calculate values for this food
            calories = Decimal('0')
            protein = Decimal('0')
            carbs = Decimal('0')
            fat = Decimal('0')
            ...
            if nutrients:
                ...
                saturated_fat = (nutrients.saturated_fat_g_100g or Decimal('0')) * multiplier
    ...
    def get_nutrient_by_food_id(self, food_id: UUID) -> FoodNutrient | None:
        """
